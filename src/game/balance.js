...
const SURV_POWER=1,DEATH_STEP=0.2,DEATH_CAP=0.8,OVER_DUR=3;
...
function deathPct(tier,power){return tier<=1?0:Math.max(0,Math.min(DEATH_CAP,(darkBase(tier)-power+1)*DEATH_STEP));}
