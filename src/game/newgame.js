...
4:{camp:1,grocery:[1,2],scrap:[1,2],light:[1,2],cache:[1,2],rubble:2,pr:[0,1]},
...
G={v:10,day:1,food:START_FOOD,mats:0,pr:0,light:1,boDay:0,boCount:0,boNeed:0,boFast:false,items:{p1:0,p2:0},matsSeen:false,opened:false,atkN:0,nextAtk:rollRange(ATK_FIRST),peak:2,soleMusic:false,starveStreak:0,tiles,survivors,names:NAME_BAG.slice(),faces:[3,4]};
