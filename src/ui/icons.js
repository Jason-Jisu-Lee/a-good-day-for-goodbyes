...
function ringSheet(col){const c=mk(10),g=c.getContext("2d");g.fillStyle=col;for(let y=0;y<10;y++)for(let x=0;x<10;x++){const d=Math.hypot(x-4.5,y-4.5);if(d<=4.8)g.fillRect(x,y,1,1);}return c;}
const RINGS={},RINGS_D={};
