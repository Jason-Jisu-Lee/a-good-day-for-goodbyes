...
cx.lineWidth=r*0.34;
cx.beginPath();
cx.moveTo(r*0.3,-r*0.3);
cx.lineTo(-r*0.56,r*0.56);
cx.stroke();
cx.beginPath();
cx.arc(r*0.3,-r*0.3,r*0.48,0,Math.PI*2);
cx.fill();
cx.beginPath();
cx.arc(-r*0.56,r*0.56,r*0.31,0,Math.PI*2);
cx.fill();
cx.globalCompositeOperation="source-over";
cx.beginPath();
cx.arc(r*0.3,-r*0.3,r*0.26,0,Math.PI*2);
cx.fill();
cx.beginPath();
cx.arc(-r*0.56,r*0.56,r*0.16,0,Math.PI*2);
cx.fill();
cx.restore();
}
