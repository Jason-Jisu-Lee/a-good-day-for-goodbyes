...
dbg.innerHTML='<div id="dbgstat"></div><div style="margin-top:6px"><button data-a="mats">+25 MATS</button> <button data-a="light">+5 LIGHT</button> <button data-a="surv">+SURV</button></div><div style="margin-top:6px">SPEED <button data-a="x1">X1</button> <button data-a="x2">X2</button> <button data-a="x3">X3</button> <button data-a="x4">X4</button> <button data-a="x5">X5</button> <button data-a="x20">X20</button></div>';
document.body.appendChild(dbg);
dbg.addEventListener("click",e=>{
const a=e.target.dataset&&e.target.dataset.a;
if(!a||!G)return;
if(a==="mats")G.mats+=25;
if(a==="light")G.light=(G.light||0)+5;
