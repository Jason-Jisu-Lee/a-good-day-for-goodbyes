...
dbg.innerHTML='<div id="dbgstat"></div><div style="margin-top:6px"><button data-a="food">+25 FOOD</button> <button data-a="mats">+25 MATS</button> <button data-a="surv">+SURV</button></div><div style="margin-top:6px">SPEED <button data-a="x1">X1</button> <button data-a="x2">X2</button> <button data-a="x3">X3</button> <button data-a="x4">X4</button> <button data-a="x5">X5</button> <button data-a="x20">X20</button></div>';
