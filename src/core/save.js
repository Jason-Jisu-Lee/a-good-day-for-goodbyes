...
const data={v:9,day:G.day,food:G.food,mats:G.mats,pr:G.pr||0,items:{p1:G.items&&G.items.p1||0,p2:G.items&&G.items.p2||0},tutDay:G.tutDay||3,zoomTipSeen:!!G.zoomTipSeen,matsSeen:G.matsSeen,opened:G.opened,atkN:G.atkN||0,nextAtk:G.nextAtk,names:G.names,faces:G.faces,
tiles:G.tiles.map(t=>({gx:t.gx,gy:t.gy,kind:t.kind,state:t.state,turnsLeft:t.turnsLeft||0,atk:!!t.atk,atkS:t.atkS||0,action:t.action})),
...
G={v:9,day:d.day,food:d.food,mats:d.mats,pr:d.pr||0,items:{p1:d.items&&d.items.p1||0,p2:d.items&&d.items.p2||0},tutDay:d.tutDay==null?3:d.tutDay,zoomTipSeen:!!d.zoomTipSeen,matsSeen:!!d.matsSeen||d.mats>0,opened,atkN:d.atkN||0,nextAtk:d.nextAtk==null?rollRange(ATK_FIRST):d.nextAtk,tiles:[],survivors:[]};
G.tiles=d.tiles.map(t=>({gx:t.gx,gy:t.gy,kind:t.kind,state:t.state,turnsLeft:t.turnsLeft||0,atk:!!t.atk,atkS:t.atkS||0,action:t.action}));
