...
const data={v:10,day:G.day,food:G.food,mats:G.mats,pr:G.pr||0,light:G.light||0,boDay:G.boDay||0,boCount:G.boCount||0,boNeed:G.boNeed||0,boFast:!!G.boFast,items:{p1:G.items&&G.items.p1||0,p2:G.items&&G.items.p2||0},matsSeen:G.matsSeen,opened:G.opened,atkN:G.atkN||0,nextAtk:G.nextAtk,names:G.names,faces:G.faces,peak:G.peak||G.survivors.length,soleMusic:!!G.soleMusic,starveStreak:G.starveStreak||0,
...
G={v:10,day:d.day,food:d.food,mats:d.mats,pr:d.pr||0,light:d.light||0,boDay:d.boDay||0,boCount:d.boCount||0,boNeed:d.boNeed||0,boFast:!!d.boFast,items:{p1:d.items&&d.items.p1||0,p2:d.items&&d.items.p2||0},matsSeen:!!d.matsSeen||d.mats>0,opened,atkN:d.atkN||0,nextAtk:d.nextAtk==null?rollRange(ATK_FIRST):d.nextAtk,names:d.names||NAME_BAG.slice(),faces:d.faces||[2,3,4],peak:Math.max(d.peak||0,d.survivors.length),soleMusic:!!d.soleMusic,starveStreak:d.starveStreak||0,tiles:[],survivors:[]};
