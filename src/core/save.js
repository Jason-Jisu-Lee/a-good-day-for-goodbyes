function save(){
if(saveGag||!G)return;
const data={v:5,t:G.t,day:G.day,dayT:G.dayT,food:G.food,mats:G.mats,pr:G.pr||0,matsSeen:G.matsSeen,opened:G.opened,attackOn:!!G.attackOn,atkTimer:G.atkTimer||0,names:G.names,faces:G.faces,
...
G={v:5,t:d.t,day:d.day,dayT:d.dayT,food:d.food,mats:d.mats,pr:d.pr||0,matsSeen:!!d.matsSeen||d.mats>0,opened,attackOn:!!d.attackOn,atkTimer:d.atkTimer||ATTACK_EVERY,names:d.names,faces:d.faces,tiles:[],survivors:[]};
G.tiles=d.tiles.map(t=>({gx:t.gx,gy:t.gy,kind:t.kind,state:t.state,dark:t.dark||0,atk:t.atk||0,progress:t.progress,action:t.action}));
