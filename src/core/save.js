...
const data={v:7,day:G.day,food:G.food,mats:G.mats,pr:G.pr||0,matsSeen:G.matsSeen,opened:G.opened,atkDay:G.atkDay,atkT:G.atkT,names:G.names,faces:G.faces,
...
if(d.v!==7)return false;
const opened=!d.tiles.some(t=>t.gx>=OB0&&t.gx<=OB1&&t.gy>=OB0&&t.gy<=OB1&&t.state!=="owned");
G={v:7,day:d.day,food:d.food,mats:d.mats,pr:d.pr||0,matsSeen:!!d.matsSeen||d.mats>0,opened,atkDay:d.atkDay==null?ATK_DAY_MIN:d.atkDay,atkT:d.atkT==null?0:d.atkT,tiles:[],survivors:[]};
