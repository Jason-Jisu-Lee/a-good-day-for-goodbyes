...
const data={v:10,day:G.day,food:G.food,mats:G.mats,pr:G.pr||0,light:G.light||0,boDay:G.boDay||0,boCount:G.boCount||0,items:{p1:G.items&&G.items.p1||0,p2:G.items&&G.items.p2||0},tutDay:G.tutDay||3,zoomTipSeen:!!G.zoomTipSeen,tut:G.tut||0,atkTipSeen:!!G.atkTipSeen,matsSeen:G.matsSeen,opened:G.opened,atkN:G.atkN||0,nextAtk:G.nextAtk,names:G.names,faces:G.faces,
...
G={v:10,day:d.day,food:d.food,mats:d.mats,pr:d.pr||0,light:d.light||0,boDay:d.boDay||0,boCount:d.boCount||0,items:{p1:d.items&&d.items.p1||0,p2:d.items&&d.items.p2||0},tutDay:d.tutDay==null?3:d.tutDay,zoomTipSeen:!!d.zoomTipSeen,tut:d.tut||0,atkTipSeen:!!d.atkTipSeen,matsSeen:!!d.matsSeen||d.mats>0,opened,atkN:d.atkN||0,nextAtk:d.nextAtk==null?rollRange(ATK_FIRST):d.nextAtk,tiles:[],survivors:[]};
