...
const data={v:8,day:G.day,food:G.food,mats:G.mats,pr:G.pr||0,matsSeen:G.matsSeen,opened:G.opened,atkN:G.atkN||0,nextAtk:G.nextAtk,names:G.names,faces:G.faces,
...
if(d.v!==8)return false;
const opened=!d.tiles.some(t=>t.gx>=OB0&&t.gx<=OB1&&t.gy>=OB0&&t.gy<=OB1&&t.state!=="owned");
G={v:8,day:d.day,food:d.food,mats:d.mats,pr:d.pr||0,matsSeen:!!d.matsSeen||d.mats>0,opened,atkN:d.atkN||0,nextAtk:d.nextAtk==null?rollRange(ATK_FIRST):d.nextAtk,tiles:[],survivors:[]};
