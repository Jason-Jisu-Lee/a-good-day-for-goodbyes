function save(){
if(saveGag||!G)return;
const data={v:5,t:G.t,day:G.day,dayT:G.dayT,food:G.food,mats:G.mats,matsSeen:G.matsSeen,opened:G.opened,names:G.names,faces:G.faces,
...
G={v:5,t:d.t,day:d.day,dayT:d.dayT,food:d.food,mats:d.mats,matsSeen:!!d.matsSeen||d.mats>0,opened,names:d.names,faces:d.faces,tiles:[],survivors:[]};
