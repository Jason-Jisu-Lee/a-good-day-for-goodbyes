...
const data={v:9,day:G.day,food:G.food,mats:G.mats,pr:G.pr||0,items:{p1:G.items&&G.items.p1||0,p2:G.items&&G.items.p2||0},matsSeen:G.matsSeen,opened:G.opened,atkN:G.atkN||0,nextAtk:G.nextAtk,names:G.names,faces:G.faces,
...
G={v:9,day:d.day,food:d.food,mats:d.mats,pr:d.pr||0,items:{p1:d.items&&d.items.p1||0,p2:d.items&&d.items.p2||0},matsSeen:!!d.matsSeen||d.mats>0,opened,atkN:d.atkN||0,nextAtk:d.nextAtk==null?rollRange(ATK_FIRST):d.nextAtk,tiles:[],survivors:[]};
